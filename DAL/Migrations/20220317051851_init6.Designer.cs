...
namespace DAL.Migrations
{
    ...
    [Migration("20220317051851_init6")]
    partial class init6
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.SeasonType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("SeasionBegin")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("SeasionEnd")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DAL.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("DAL.Models.RoomType", "Room")
                        .WithMany()
                        .HasForeignKey("RoomID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.ApplicationUsersIdentity", "User")
                        .WithMany()
